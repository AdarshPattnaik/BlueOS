  ...
  >
    <v-card>
      ...
      <v-card-text>
        ...
        <v-expansion-panels
          v-if="settings.is_pirate_mode && isLinuxFlightController"
        >
          <v-expansion-panel>
            <v-expansion-panel-header>
    ...
    <board-change-dialog v-model="show_board_change_dialog" />
  </v-card>
</template>
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      fetch_available_boards_task: new OneMoreTime({
        delay: 5000,
        disposeWith: this,
      }),
      fetch_current_board_task: new OneMoreTime({
        delay: 5000,
        disposeWith: this,
      }),
      fetch_firmware_info_task: new OneMoreTime({
        delay: 5000,
        disposeWith: this,
      }),
      fetch_vehicle_type_task: new OneMoreTime({
        delay: 5000,
        disposeWith: this,
      }),
    }
